...
@FacesValidator("mobileNoValidatorForBigInt")
	public class MobileNoValidatorForBigInt implements Validator {
		
		public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
                   
                    BigInteger bi=new BigInteger((byte[]) value);
                    String phNumber=bi.toString();
